...
export const SERVICES = [
  ...
  { icon: '📝', title: 'Workforce Scaling Strategy', desc: 'Consulting frameworks for scalable workforce solutions designed for total business agility. In today’s fast-paced market, rigid organizational structures often hinder growth and responsiveness. We provide strategic guidance on how to leverage contract staffing and external talent pools to rapidly scale up for critical projects or effortlessly manage seasonal surges.', slug: 'workforce-scaling', image: contractStaffingImg },
  { icon: '✅', title: 'Background Verification Protocols', desc: 'Consulting on comprehensive, risk-mitigating candidate screening policies. Hiring the wrong candidate can cost your business significantly. We help you design a rigorous, multi-tiered verification process that dives deep beyond the resume, ensuring your internal HR teams know exactly how to validate credentials and protect your company culture.', slug: 'background-verification', image: backgroundVerificationImg },
  { icon: '🤝', title: 'HR Consulting Services', desc: 'Strategic human resource advisory so you can focus on core business growth. We help you build robust internal HR systems—from designing seamless onboarding and performance management processes to compliance tracking frameworks and daily HR operational SOPs.', slug: 'hr-consulting', image: hrOutsourcingImg },
  { icon: '🎓', title: 'Campus Recruitment Strategy', desc: 'Strategic early-talent acquisition planning. We help you design high-impact campus recruitment drives and internship programs, enabling your internal teams to secure the brightest fresh talent to build your future leadership pipeline.', slug: 'campus-recruitment-strategy', image: campusRecruitmentImg },
  { icon: '👔', title: 'Planning for Recruitment Strategies', desc: 'Targeted acquisition frameworks for visionary leadership. We help you build behavioral science-backed recruitment funnels and interview protocols to identify, engage, and secure leaders who align perfectly with your organizational DNA and strategic goals.', slug: 'recruitment-strategies', image: executiveSearchImg },
]
