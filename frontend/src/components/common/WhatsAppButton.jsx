...
export default function WhatsAppButton() {
  return (
    <motion.a href={`https://wa.me/${BRAND.whatsapp}`} target="_blank" rel="noopener noreferrer"
      ...
      style={{ background: '#25D366', boxShadow: '0 8px 24px rgba(37,211,102,0.35)' }} title="Chat on WhatsApp">
